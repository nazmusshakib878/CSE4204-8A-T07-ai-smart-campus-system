...
function HomePage() {
  ...
  return (
    <Layout title="Welcome to NUBTK Campus" subtitle="A smart platform for students, faculty, and administrators.">
      <section className="row align-items-center g-5 mb-5">
        ...
        <div className="col-lg-5">
          <div className="card border-0 shadow-lg rounded-4 overflow-hidden">
            <img src={campusImg} alt="Campus management preview" className="img-fluid" style={{ height: 320, objectFit: 'cover' }} />
      ...
      <section className="rounded-4 p-5 text-white" style={{ background: 'linear-gradient(135deg, #1d4ed8, #0f172a)' }}>
